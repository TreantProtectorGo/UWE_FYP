...
import { roadClosureAPI } from '../services/api';
  ...
  const fetchData = async () => {
    ...
    try {
      const result = activeTab === 'active' 
        ? await roadClosureAPI.getActive()
        : await roadClosureAPI.getHistory();
      // Sort by time desc
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[80vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <div className="p-6 overflow-y-auto max-h-[calc(80vh-120px)]">
              <div className="text-sm text-gray-500 mb-4">
                {t('roadClosure.updated')}{selectedItem.time}
              </div>
              <div 
